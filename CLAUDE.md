...
- `DESIGN.md` -- visual (color tokens, typography, components); generated by `/impeccable document`
...
Use `/impeccable` subcommands (`critique`, `polish`, `bolder`, `quieter`, etc.) for design work; they auto-load `PRODUCT.md` and `DESIGN.md`.
